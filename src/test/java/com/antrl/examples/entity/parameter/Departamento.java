...
public class Departamento implements Serializable {
	...
	@Id
	@Column(name = "CD_DEPARTAMENTO", length = 5, unique = true)
	private Integer codigo;

	@Column(name = "DS_CORTA", length = 5, unique = true)
	private String descripcionCorta;
	
	@Column(name = "DS_DEPARTAMENTO", length = 40, unique = true)
  ...
  CREATE TABLE "DESALOCAL_LAN"."G003" 
   (	"CD_DEPARTAMENTO" VARCHAR2(5 CHAR) NOT NULL ENABLE, 
	"DS_DEPARTAMENTO" VARCHAR2(40 CHAR), 
	"DS_CORTA" VARCHAR2(5 CHAR), 
